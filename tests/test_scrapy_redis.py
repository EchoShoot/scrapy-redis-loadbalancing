...
from scrapy_redis_loadbalancing import connection
from scrapy_redis_loadbalancing.dupefilter import RFPDupeFilter
from scrapy_redis_loadbalancing.queueS import FifoQueue, LifoQueue, PriorityQueue
from scrapy_redis_loadbalancing.scheduler import Scheduler
...
class DupeFilterTest(RedisTestMixin, TestCase):
    ...
    def setUp(self):
        self.key = 'scrapy_redis_loadbalancing:tests:dupefilter:'
...
class QueueTestMixin(RedisTestMixin):
    ...
    def setUp(self):
        ...
        self.key = 'scrapy_redis_loadbalancing:tests:%s:queue' % self.spider.name
...
class SchedulerTest(RedisTestMixin, TestCase):
    ...
    def setUp(self):
        self.key_prefix = 'scrapy_redis_loadbalancing:tests:'
