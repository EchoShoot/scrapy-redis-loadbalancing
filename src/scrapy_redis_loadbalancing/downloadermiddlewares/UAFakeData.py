...
__all__ = ["get_user_agent_by_random"]
...
User_Agent_Both = User_Agent_Phone + User_Agent_PC
...
def get_user_agent_by_random(option):
    assert option.upper() in ("PC","PHONE","BOTH"),"only received PC PHONE and BOTH"
    table = {"PC":User_Agent_PC,"PHONE":User_Agent_Phone,"BOTH":User_Agent_Both}
    User_Agent = random.choice(table[option.upper()])
    return User_Agent